...
@Component({
    selector: 'popup-unpack',
    templateUrl: './popup-unpack.component.html',
    styleUrls: ['./popup-unpack.component.less']
})

export class PopupUnpackComponent extends AppComponentBase {
    @ViewChild('popupUnpack', { static: false }) modal: ModalDirective | undefined;
