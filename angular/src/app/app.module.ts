import { CoreModule } from './../assets/metronic/app/core/core.module';
import { CommonModule } from '@angular/common';
import { APP_INITIALIZER, CUSTOM_ELEMENTS_SCHEMA, ErrorHandler, Injector, NO_ERRORS_SCHEMA, NgModule } from '@angular/core';
...
import { QuickAccessComponent } from './shared/layout/topbar/quick-access.component';
import { VersionUpdateHandlerService } from '@shared/utils/version-update-handler.service';
...
@NgModule({
    ...
    providers: [
        ...
        },
        {
            ...
            useClass: VersionUpdateHandlerService
        }
    ],
    imports: [
        CommonModule,
