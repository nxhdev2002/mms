...
namespace prod.Frame.Andon
{
	...
	[Table("FrmAdoFramePlanA1_T")]
	[Index(nameof(No), Name = "IX_FrmAdoFramePlanA1_T_No")]
	[Index(nameof(LotNo), Name = "IX_FrmAdoFramePlanA1_T_LotNo")]
	[Index(nameof(NoInLot), Name = "IX_FrmAdoFramePlanA1_T_NoInLot")]
	[Index(nameof(FrameId), Name = "IX_FrmAdoFramePlanA1_T_FrameId")]
	[Index(nameof(PlanMonth), Name = "IX_FrmAdoFramePlanA1_T_PlanMonth")]
	[Index(nameof(PlanDate), Name = "IX_FrmAdoFramePlanA1_T_PlanDate")]
	public class FrmAdoFramePlanA1_T : FullAuditedEntity<long>, IEntity<long>
	{
