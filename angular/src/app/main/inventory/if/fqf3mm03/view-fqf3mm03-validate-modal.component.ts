...
@Component({
    templateUrl: './view-fqf3mm03-validate-modal.component.html',
    selector: 'view-fqf3mm03-validate-modal'
})
export class ViewFqf3mm03ValidateModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewFqf3mm03Validate', { static: true }) modal: ModalDirective | undefined;
    ...
    show(postingDateFrom?: any, postingDate?: any): void {
        ...
        this.isLoading = true;
        this._service.getInvInterfaceFQF3MM03Validate(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getInvInterfaceFQF3MM03Validate(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDate),
            '',
            this.paginationParams.skipCount,
    ...
    exportToExcel(e): void {
        ...
        this._service.getValidate_FQF3MM03ToExcel(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDate),
