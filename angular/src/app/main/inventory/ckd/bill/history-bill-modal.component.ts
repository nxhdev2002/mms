...
import { InvCkdPartListDto, InvCkdPartListServiceProxy, InvCkdBillDto, InvCkdBillServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-bill-modal',
    templateUrl: './history-bill-modal.component.html'
})
export class ViewHistoryBillModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryBillModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvCkdBill')
    }

    getData(_id,_tableName){
        this._service.getBillHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getBillHistory(
            this.id,
            'InvCkdBillList',
            '',
            this.paginationParams.skipCount,
