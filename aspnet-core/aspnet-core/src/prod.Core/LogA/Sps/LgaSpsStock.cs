...
{
    [Table("LgaSpsStock")]
    [Index(nameof(PartNo), Name = "IX_LgaSpsStock_PartNo")]
    [Index(nameof(SupplierNo), Name = "IX_LgaSpsStock_SupplierNo")]
    [Index(nameof(SpsRackAddress), Name = "IX_LgaSpsStock_SpsRackAddress")]
    [Index(nameof(IsActive), Name = "IX_LgaSpsStock_IsActive")]

    public class LgaSpsStock : FullAuditedEntity<long>, IEntity<long>
    {
