...
import { InvCkdRundownShippingScheduleServiceProxy, InvGpsStockRundownDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './stock-rundown-shipping-schedule.component.html',
})
export class StockRundownShippingScheduleComponent extends AppComponentBase implements OnInit {
    ...
    constructor(
        injector: Injector,
        private _service: InvCkdRundownShippingScheduleServiceProxy,
    ...
    autoSizeAll() {
        ...
        this.dataParams.columnApi!.getAllColumns()!.forEach((column) => {
            if (column.getId().toString() != "stt"
                ...
                && column.getId().toString() != "PartName"
                && column.getId().toString() != "CupplierNo"
    ...
    exportToExcel(e): void {
        this.fn.exportLoading(e, true);
        this._service.getExportShipScheduleRundownToExcel(
            this.partNo,
            this.p_CfcCode,
            this.p_SupplierCode
        )
