...
import { InvPIOStockTransactionDto, InvPIOStockIssuingServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './stockissuing.component.html',
})
export class StockIssuingComponent extends AppComponentBase implements OnInit {
    ...
    rowData: any[] = [];
    rowDataStockIssuing :InvPIOStockTransactionDto[] = [];
    gridApi!: GridApi;
    ...
    constructor(
        injector: Injector,
        private _service: InvPIOStockIssuingServiceProxy,
