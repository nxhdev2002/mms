...
namespace prod.Master.LogA
{
	...
	[Table("MstLgaBp2PartListGrade_T")]
	[Index(nameof(PartNo), Name = "IX_MstLgaBp2PartListGrade_T_PartName")]
    [Index(nameof(ProdLine), Name = "IX_MstLgaBp2PartListGrade_T_ProdLine")]
	[Index(nameof(Grade), Name = "IX_MstLgaBp2PartListGrade_T_PikProcess")]
    [Index(nameof(IsActive), Name = "IX_MstLgaBp2PartListGrade_T_IsActive")]
	public class MstLgaBp2PartListGrade_T : FullAuditedEntity<long>, IEntity<long>
	{
