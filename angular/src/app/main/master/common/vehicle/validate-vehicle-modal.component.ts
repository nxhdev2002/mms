...
@Component({
    selector: 'validate-vehicle-modal',
    templateUrl: './validate-vehicle-modal.component.html',
})
export class ValidateVehicleModalComponent extends AppComponentBase {
    @ViewChild('validateVehicle', { static: true }) modal: ModalDirective | undefined;
