...
@Component({
    selector: 'import-gpsmaster',
    templateUrl: './import-gpsmaster.component.html',
    styleUrls: ['../../../import-modal.less'],
})
export class ImportGpsMasterComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportInvGpsPartListByCategoryFromExcel';
            { }
    }
    ngOnInit() {
