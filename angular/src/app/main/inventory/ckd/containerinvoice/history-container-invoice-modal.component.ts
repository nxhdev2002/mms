...
import { InvCkdPartGradeDto, InvCkdContainerInvoiceDto, InvCkdContainerInvoiceServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-container-invoice-modal',
    templateUrl: './history-container-invoice-modal.component.html'
})
export class ViewHistoryContainerInvoiceModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryContainerInvoiceModal', { static: true }) modal: ModalDirective | undefined
    ...
    listData: any;
    selectedRow: InvCkdContainerInvoiceDto;
    rowdata: any[];
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvCkdContainerInvoice')


    }

    getData(_id, _tableName) {
        this._service.getContainerInvoiceHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getContainerInvoiceHistory(
            this.Id,
            'InvCkdContainerInvoice',
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        )
