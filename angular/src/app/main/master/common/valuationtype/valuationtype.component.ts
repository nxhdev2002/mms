...
export class ValuationTypeComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MstCmmValuationTypeDto = new MstCmmValuationTypeDto();
    saveSelectedRow: MstCmmValuationTypeDto = new MstCmmValuationTypeDto();
    datas: MstCmmValuationTypeDto = new MstCmmValuationTypeDto();
    ...
    constructor(
        injector: Injector,
        private _service: MstCmmValuationTypeServiceProxy,
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => MstCmmValuationTypeDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new MstCmmValuationTypeDto();
    ...
    exportToExcel(e): void {
       ...
       this.fn.exportLoading(e, true);
        this._service.getValuationTypeToExcel(
			this.code,
			//this.name
            )
		.subscribe((result) => {
