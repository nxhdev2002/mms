...
import { MstCmmMaterialMasterServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-materialmaster-modal',
    templateUrl: './history-materialmaster-modal.component.html'
})
export class ViewHistoryMaterialMasterModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryMaterialMasterModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmMaterialMaster')
    }

    getData(_id,_tableName){
        this._service.getMstCmmMaterialMasterHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMstCmmMaterialMasterHistory(
            this.id,
            'MstCmmMaterialMaster',
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        )
