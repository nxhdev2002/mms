...
@Component({
    selector: 'import-materialregisterbyshop',
    templateUrl: './import-gpsmaterialregisterbyshop.component.html',
    styleUrls: ['../../../import-modal.less'],
})
export class ImportGpsMaterialRegisterByShopComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportMaterialRegisterByShopFromExcel';
            { }
    }
    ngOnInit() {
