...
@Component({
    selector: 'list-error-import-gpsmaterial',
    templateUrl: './list-error-import-gpsmaterial-modal.component.html',
    styleUrls: ['./list-error-import-gpsmaterial-modal.component.less'],
})
export class ListErrorImportGpsMaterialExcelComponent extends AppComponentBase {
    ...
    constructor(
        ...
        private _import: ImportGpsMaterialComponent
    ) {
        super(injector);
        { }
    }
