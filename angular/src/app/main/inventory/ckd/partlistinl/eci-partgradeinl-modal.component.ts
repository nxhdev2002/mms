...
@Component({
    selector: 'eci-partgradeinl-modal',
    templateUrl: './eci-partgradeinl-modal.component.html',
    styleUrls: ['./eci-partgradeinl-modal.component.less']
})
export class EciPartGradeInlModalComponent extends AppComponentBase {
    @ViewChild('eciPartGradeModal', { static: true }) modal: ModalDirective | undefined;
    ...
    show(rowdata?: InvPioPartGradeInlDto): void {
        this.bodyColorList = [];
        this.gradeListc = [];
        this.colorList = [];
        this.gradeLists1 = [];
    ...
    save(): void {
        ...
        if (this.checkeci) {
            this.isLoading = true;
            this._service.eciPartGrade(this.rowdata.id, this.rowdata.startLot, this.rowdata.startRun, this.rowdata.grade, Number(this._usageQty))
