...
export class ViewFundCommmitmentItemDMComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('viewRequestCmmSelected', { static: true }) viewRequestCmmSelected: ViewRequestCmmSelectedComponent | undefined;
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getViewFundCommmitmentItemDM(
            this.idFund,
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
    ...
    showRequest(){
        this.viewRequestCmmSelected.show(this.logId);
    }
