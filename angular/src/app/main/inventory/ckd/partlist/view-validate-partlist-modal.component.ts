...
import { GetGradebyPartListDto, GetPartListGradeDto, InvCkdPartGradeDto, InvCkdPartListDto, InvCkdPartListServiceProxy, MstLgaBp2PartListServiceProxy, ValidatePartListDto } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'view-validate-partlist-modal',
    templateUrl: './view-validate-partlist-modal.component.html'
})
export class ViewValidatePartListModalComponent extends AppComponentBase {
    ...
    constructor(
        ...
        this.validateColDef = [
            ...
            {
                headerName: this.l('PartGradeId'),
                headerTooltip: this.l('PartGradeId'),
                field: 'partGradeId',
    ...
    show(): void {
        ...
        this.isLoading = true
        this._service.getValidateInvCkdPartList(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getValidateInvCkdPartList(
    ...
    exportToExcel(e): void {
        ...
        this._service.getValidateInvCkdPartListExcel(
        ).subscribe((result) => {
            setTimeout(() => {
