...
@Component({
    templateUrl: './view-fqf3mm07-validate-modal.component.html',
    selector: 'view-fqf3mm07-validate-modal'
})
export class ViewFqf3mm07ValidateModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewFqf3mm07Validate', { static: true }) modal: ModalDirective | undefined;
    ...
    show(postingDateFrom?: any, postingDate?: any): void {
        ...
        this.isLoading = true;
        this._service.getInvInterfaceFQF3MM07Validate(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getInvInterfaceFQF3MM07Validate(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDate),
            '',
            this.paginationParams.skipCount,
    ...
    exportToExcel(e): void {
        ...
        this._service.getFQF3MM07VALIDATEToExcel(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDate),
        ).subscribe((result) => {
            setTimeout(() => {
