...
import { LgaLdsLotPlanServiceProxy, MstLgwUnpackingPartServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
  selector: 'import-lotup-modal',
  templateUrl: './import-lotup-modal.component.html',
  styleUrls: ['./import-lotup-modal.component.less']
})
export class ImportLotupModalComponent extends AppComponentBase {
    ...
    constructor(
      ...
      private _unpackingPart: LotplanComponent
    ) {
      super(injector);
      this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportLgaLdsLotPlanFromExcel';
      {}
    }
    ngOnInit() {
    ...
    mergeUnpackingPart(guid) {
        this.isLoading = true;
        this._service.mergeDataLgaLdsLotPlan(guid)
            .pipe(
                finalize(() => {
                    this.isLoading = false;
                })
