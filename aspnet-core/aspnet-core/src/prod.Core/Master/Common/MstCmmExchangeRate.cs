...
namespace prod.Master.Common
{
    ...
    [Table("MstCmmExchangeRate")]
    [Index(nameof(ExchangeDate), Name = "IX_MstCmmExchangeRate_ExchangeDate")]
    [Index(nameof(IsActive), Name = "IX_MstCmmExchangeRate_IsActive")]
    public class MstCmmExchangeRate : FullAuditedEntity<long>, IEntity<long>
    {
