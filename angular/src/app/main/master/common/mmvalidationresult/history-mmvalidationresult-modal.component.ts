...
@Component({
    selector: 'history-mmvalidationresult-modal',
    templateUrl: './history-mmvalidationresult-modal.component.html'
})
export class ViewHistoryMMValidationResultModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryMMValidationResultModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmMMvalidationResult')
    }

    getData(_id,_tableName){
        this._service.getMstCmmMMValidationResultHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMstCmmMMValidationResultHistory(
            this.id,
