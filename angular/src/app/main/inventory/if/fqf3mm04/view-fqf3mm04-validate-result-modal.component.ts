...
@Component({
    templateUrl: './view-fqf3mm04-validate-result-modal.component.html',
    selector: 'view-fqf3mm04-validate-result-modal'
})
export class ViewFqf3mm04ValidateResultModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewFqf3mm04ValidateResult', { static: true }) modal: ModalDirective | undefined;
    ...
    show(devaningDateFrom?: any,devaningDateTo?: any): void {
        ...
        this.isLoading = true;
        this._service.getInvInterfaceFQF3MM04ValidateResult(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getInvInterfaceFQF3MM04ValidateResult(
            this._dateTimeService.convertToDatetime(this.devaningDateFrom),
            this._dateTimeService.convertToDatetime(this.devaningDateTo),
            '',
            this.paginationParams.skipCount,
    ...
    exportToExcel(e): void {
        ...
        this._service.getValidateResult_FQF3MM04ToExcel(
            this._dateTimeService.convertToDatetime(this.devaningDateFrom),
            this._dateTimeService.convertToDatetime(this.devaningDateTo)
