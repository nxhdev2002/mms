...
//     selector: 'import-smqdmanagement',
//     templateUrl: './import-smqdmanagement.component.html',
//     styleUrls: ['../../../import-modal.less'],
// })
// export class ImportInvCkdSmqdComponent extends AppComponentBase {
//     @ViewChild('imgInput', { static: false }) InputVar: ElementRef;
//     @ViewChild('ExcelFileUpload', { static: false }) excelFileUpload: FileUpload;
//     @ViewChild('importModal', { static: true }) modal: ModalDirective;
//     @ViewChild('errorListModal', { static: true }) errorListModal: ListErrorImportInvCkdSmqdComponent;
...
//                 .subscribe(response => {
//                     if (response.success) {
//                         if (response.result.smqd.result.length == 0) {
//                             this.exeptionDataImport();
//                         }
//                         else {
//                             //this.mergeCkdSmqd(response.result.smqd.result[0].guid);
//                         }
//                     }
//                 },
//                 (error) => {
...
//     // mergeCkdSmqd(guid) {
//     //     this._service.mergeDataInvCkdSmqd(guid)
//     //         .pipe(
//     //             finalize(() => {
