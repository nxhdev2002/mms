...
export class CommonFunction {
    ...
    start_time:any;
    end_time:any;
    exportLoading(e, _isLoad?:boolean, _cd?:number) { 
        console.log(e, e.srcElement.classList);
        if (_isLoad) {
            ...
            let coundown = _countdown-ms; coundown = (coundown > 0) ? coundown: 0;
            setTimeout(() => {
