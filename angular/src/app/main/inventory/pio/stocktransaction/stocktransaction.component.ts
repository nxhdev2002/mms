...
import { InvPIOStockTransactionDto, InvPIOStockTransactionServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class StockTransactionComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: InvPIOStockTransactionDto = new InvPIOStockTransactionDto();
    saveSelectedRow: InvPIOStockTransactionDto = new InvPIOStockTransactionDto();
    datas: InvPIOStockTransactionDto = new InvPIOStockTransactionDto();
    ...
    constructor(
        injector: Injector,
        private _service: InvPIOStockTransactionServiceProxy,
        ...
        this.defaultColDefs = [
          ...
          //  { headerName: this.l('Part Id'), headerTooltip: this.l('Part Id'), field: 'partId' },
            ...
            //{ headerName: this.l('Trans Id'), headerTooltip: this.l('Trans Id'), field: 'transId' },
            {
                ...
                valueGetter: (params) => this.pipe.transform(params.data?.transDatetime, 'dd/MM/yyyy HH:mm:ss'),
            },
    ...
    exportToExcel(e): void {
        ...
        this._service.getStockTransactionToExcel(
            this.partNo,
            this.mktCode,
            this.vinNo,
            this._dateTimeService.convertToDatetime(this.workingDateFrom),
