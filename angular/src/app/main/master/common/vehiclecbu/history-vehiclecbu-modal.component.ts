...
import { MstCmmVehicleCBUServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-vehiclecbu-modal',
    templateUrl: './history-vehiclecbu-modal.component.html'
})
export class ViewHistoryVehicleCBUModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryVehicleCBUModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmVehicleCBU')
    }

    getData(_id,_tableName){
        this._service.getMstCmmVehicleCBUHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMstCmmVehicleCBUHistory(
            this.id,
            'MstCmmVehicleCBU',
            '',
            this.paginationParams.skipCount,
