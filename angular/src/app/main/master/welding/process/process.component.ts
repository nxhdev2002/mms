...
import { MstWldProcessDto, MstWldProcessServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class ProcessComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MstWldProcessDto = new MstWldProcessDto();
    saveSelectedRow: MstWldProcessDto = new MstWldProcessDto();
    datas: MstWldProcessDto = new MstWldProcessDto();
    ...
    constructor(
        injector: Injector,
        private _service: MstWldProcessServiceProxy,
        ...
        this.defaultColDefs = [
            ...
            },
            {
                ...
                headerTooltip: this.l('Subgroup Name'),
                field: 'subgroupName',
                flex: 1
            },
            {
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => MstWldProcessDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new MstWldProcessDto();
    ...
    deleteRow(system: MstWldProcessDto): void {
