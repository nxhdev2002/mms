...
import { GetGradebyPartListDto, GetInvInpIfViewDto, GetPartListGradeDto, InvCkdPartGradeDto, InvCkdPartListDto, InvCkdPartListServiceProxy, InvPartListOffServiceProxy, InvPioPartListInlServiceProxy, MstLgaBp2PartListServiceProxy, ValidatePartListDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'view-validate-partlistoff-modal',
    templateUrl: './view-validate-partlistoff-modal.component.html'
})
export class ViewValidatePartListOffModalComponent extends AppComponentBase {
