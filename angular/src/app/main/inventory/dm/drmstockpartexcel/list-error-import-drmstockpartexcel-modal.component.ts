...
@Component({
    ...
    templateUrl: './list-error-import-drmstockpartexcel-modal.component.html',
    styleUrls: ['./list-error-import-drmstockpartexcel-modal.component.less'],
})
export class ListErrorImportDrmStockPartExcelComponent extends AppComponentBase {
    ...
    constructor(injector: Injector,
        ...
        private _import: ImportDrmStockPartExcelComponent
    ) {
        super(injector);
        { }
    }
