...
import { InvCkdPartGradeDto, MstCmmColorServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-color-modal',
    templateUrl: './history-color-modal.component.html' 
})
export class ViewHistoryMstCmmColorModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryMstCmmColorModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmColor')


    }

    getData(_id, _tableName) {
        this._service.getMstCmmColorHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getMstCmmColorHistory(
            this.Id,
            'MstCmmColor',
            '',
            this.paginationParams.skipCount,
