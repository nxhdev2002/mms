...
namespace prod.Master.LogA
{
	...
	[Table("MstLgaBp2PartList")]
	[Index(nameof(PartName), Name = "IX_MstLgaBp2PartList_PartName")]
    [Index(nameof(ShortName), Name = "IX_MstLgaBp2PartList_ShortName")]
    [Index(nameof(ProdLine), Name = "IX_MstLgaBp2PartList_ProdLine")]
	[Index(nameof(PikProcess), Name = "IX_MstLgaBp2PartList_PikProcess")]
    [Index(nameof(DelProcess), Name = "IX_MstLgaBp2PartList_DelProcess")]
    [Index(nameof(IsActive), Name = "IX_MstLgaBp2PartList_IsActive")]
    [Index(nameof(Remark), Name = "IX_MstLgaBp2PartList_Remark")]

    public class MstLgaBp2PartList : FullAuditedEntity<long>, IEntity<long>
	{
