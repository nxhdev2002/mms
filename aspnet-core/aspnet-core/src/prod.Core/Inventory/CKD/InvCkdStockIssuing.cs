...
namespace prod.Inventory.CKD
{
    ...
    [Table("InvCkdStockIssuing")]
    [Index(nameof(PartNo), Name = "IX_InvCkdStockIssuing_PartNo")]
    [Index(nameof(PartListId), Name = "IX_InvCkdStockIssuing_PartListId")]
    [Index(nameof(PartListGradeId), Name = "IX_InvCkdStockIssuing_PartListGradeId")]
    [Index(nameof(MaterialId), Name = "IX_InvCkdStockIssuing_MaterialId")]
    [Index(nameof(ReferenceId), Name = "IX_InvCkdStockIssuing_ReferenceId")]
    [Index(nameof(WorkingDate), Name = "IX_InvCkdStockIssuing_WorkingDate")]
    [Index(nameof(PeriodId), Name = "IX_InvCkdStockIssuing_PeriodId")]

    public class InvCkdStockIssuing : FullAuditedEntity<long>, IEntity<long>
    {
