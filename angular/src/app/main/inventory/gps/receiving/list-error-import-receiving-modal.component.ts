...
@Component({
    selector: 'list-error-import-receiving-modal',
    templateUrl: './list-error-import-receiving-modal.component.html',
    styleUrls: ['./list-error-import-receiving-modal.component.less'],
})
export class ListErrorImportReceivingComponent extends AppComponentBase {
    ...
    constructor(injector: Injector,
        ...
        private _import: ImportReceivingComponent
    ) {
        super(injector);
        { }
    }
