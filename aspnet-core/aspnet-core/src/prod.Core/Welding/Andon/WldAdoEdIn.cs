...
namespace prod.Welding.Andon
{
	...
	[Table("WldAdoEdIn")]
	[Index(nameof(Model), Name = "IX_WldAdoEdIn_Model")]
	[Index(nameof(RequestDate), Name = "IX_WldAdoEdIn_RequestDate")]
	public class WldAdoEdIn : FullAuditedEntity<long>, IEntity<long>
	{
