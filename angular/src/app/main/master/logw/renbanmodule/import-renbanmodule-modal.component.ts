...
import { MstLgwRenbanModuleServiceProxy, MstLgwUnpackingPartServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'import-renbanmodule-modal',
    templateUrl: './import-renbanmodule-modal.component.html',
    styleUrls: ['./import-renbanmodule-modal.component.less']
})
export class ImportRenbanModuleComponent extends AppComponentBase {
    ...
    constructor(
      ...
      private _unpackingPart: RenbanModuleComponent
    ) {
      super(injector);
      this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportMstLgwRenbanModuleFromExcel';
      {}
    }
    ngOnInit() {
    ...
    mergeUnpackingPart(guid) {
        this.isLoading = true;
        this._service.mergeDataMstLgwRenbanModule(guid)
            .pipe(
                finalize(() => {
                    this.isLoading = false;
                })
            ...
            .subscribe(() => {
                ...
                this.close();
                this._unpackingPart.searchDatas();
            });
    }
