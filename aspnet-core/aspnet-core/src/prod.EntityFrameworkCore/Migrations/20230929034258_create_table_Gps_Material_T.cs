...
{
    /// <inheritdoc />
    public partial class createtableGpsMaterialT : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PalletL = table.Column<int>(type: "int", nullable: true),
                    PalletR = table.Column<int>(type: "int", nullable: true),
                    PalletH = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvGpsMaterial_T", x => x.Id);
                });
        }
