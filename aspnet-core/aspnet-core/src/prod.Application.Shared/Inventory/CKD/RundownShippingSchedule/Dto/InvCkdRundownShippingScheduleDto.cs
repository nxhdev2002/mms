...
namespace prod.Inventory.CKD.RundownShippingSchedule.Dto
{
    public class InvCkdRundownShippingScheduleDto : EntityDto<long?>
    {
    ...
    public class GetStockRundownShippingScheduleInput : PagedAndSortedResultRequestDto
    {
    ...
    public class GetStockRundownShippingScheduleExportInput
    {
        public virtual string PartNo { get; set; }
