...
@Component({
    selector: 'history-material-modal',
    templateUrl: './history-material-modal.component.html'
})
export class ViewHistoryMaterialModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryMaterialModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvGpsMaterial')
    }

    getData(_id,_tableName){
        this._service.getGpsMaterialHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getGpsMaterialHistory(
            this.id,
            'InvGpsMaterial',
            '',
            this.paginationParams.skipCount,
