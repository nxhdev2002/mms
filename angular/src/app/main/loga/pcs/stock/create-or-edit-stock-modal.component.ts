...
import { CreateOrEditLgaPcsStockDto, LgaPcsStockServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditStockModalComponent extends AppComponentBase {
    ...
    rowdata: CreateOrEditLgaPcsStockDto = new CreateOrEditLgaPcsStockDto();
    ...
    constructor(
        injector: Injector,
        private _mstwptStockService: LgaPcsStockServiceProxy,
    )
    {
        super(injector);
    }

    show(rowdata?: CreateOrEditLgaPcsStockDto): void {
        if (!rowdata) this.rowdata = new CreateOrEditLgaPcsStockDto();
