...
namespace prod.Inventory.PIO.InvPioProductionPlanMonthly.Dto
{
    public class InvPioProductionPlanMonthlyDto : EntityDto<long?>
    {
    ...
    public class InvPioProductionPlanMonthlyInput : PagedAndSortedResultRequestDto
    {
        public virtual string Cfc { get; set; }
    ...
    public class InvPioProductionPlanMonthlyImportDto
    {
