...
@Component({
    selector: 'eci-partgrade-modal',
    templateUrl: './eci-partgrade-modal.component.html',
    styleUrls: ['./eci-partgrade-modal.component.less']
})
export class EciPartGradeModalComponent extends AppComponentBase {
    ...
    save(): void {
        ...
        if (this.checkeci) {
            this.isLoading = true;
            this._service.eciPartGrade(this.rowdata.id, this.rowdata.startLot, this.rowdata.startRun, this.rowdata.grade)
