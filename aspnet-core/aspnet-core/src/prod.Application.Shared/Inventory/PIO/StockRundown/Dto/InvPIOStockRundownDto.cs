...
namespace prod.Inventory.PIO.StockRundown.Dto
{
    public class InvPIOStockRundownDto : EntityDto<long?>
    {
  ...
  //    public virtual string IsActive { get; set; }
    ...
    public class GetInvPIOStockRundownInput : PagedAndSortedResultRequestDto
    {
        public virtual string PartNo { get; set; }
    ...
    public class GetInvPIOStockRundownExportInput
    {
        public virtual string PartNo { get; set; }
    ...
    public class GetInvPIOStockRundownCalculateInput 
    {
        public virtual DateTime? DateCal { get; set; }
