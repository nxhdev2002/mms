...
import { GetGradebyPartListDto, GetPartListGradeDto, InvCkdPartListServiceProxy, InvPioPartListInlDto, InvPioPartListInlServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'create-partlistinl-modal',
    templateUrl: './create-partlistinl-modal.component.html',
    styleUrls: ['./create-partlistinl-modal.component.less']
})
export class CreatePartListInlModalComponent extends AppComponentBase {
    @ViewChild('addPartListInlModal', { static: true }) modal: ModalDirective | undefined;
    @ViewChild('nameInput') nameInput: ElementRef;
    @ViewChild('datepicker', { static: false }) datepicker!: BsDatepickerDirective;
    @Output() modalSave: EventEmitter<any> = new EventEmitter<any>();
    @Output() modalClose: EventEmitter<any> = new EventEmitter<any>();

    rowdata: InvPioPartListInlDto = new InvPioPartListInlDto();
    ...
    cbbSupplierList = [{ value: '', label: 'blank' }];
    gradeList = [];
    gradeLists1 = [];
    gradeLists1_temp = [];
    colorList = [];
    ...
    constructor(
        ...
        private _partList: PioPartListInlComponent,
        private _service2: InvCkdPartListServiceProxy,
    ) {
        super(injector);
        this.partListColDef = [
            {
            ...
            },
            {
                ...
                field: 'orderPattern',
                valueGetter: (params) => { return params.data.orderPattern = 'PXP'},
                flex: 1,
            },
            {
    ...
    show(rowdata?: InvPioPartListInlDto): void {
        ...
        // list Supp
        this.cbbSupplierList = [{ value: '', label: 'blank' }];
        ...
        setTimeout(() => {
            if (!rowdata) {
                this.rowdata = new InvPioPartListInlDto();
                this.isClone = false;
                this._partNo = '';
                this._partName = '';
                this._orderPattern = 'PXP';
                this._supplierNo = '';
                this._selectCfc = '';
                this._partId = '';
                this.gradeLists1 = [];
    ...
    save(): void {
        ...
        if (this._partNo == null || this._partNo == '') {
            ...
            this.notify.warn(this.l('PartNo không lớn hơn 12 ký tự!'));
            document.getElementById('partNo').focus();
            return;
        }
        ...
        if (this.checkValidate) {
            ...
            this.isLoading = true;
            this._service.partListInlInsert(input)
