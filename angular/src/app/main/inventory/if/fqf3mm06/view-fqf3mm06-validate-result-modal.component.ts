...
@Component({
    templateUrl: './view-fqf3mm06-validate-result-modal.component.html',
    selector: 'view-fqf3mm06-validate-result-modal'
})
export class ViewFqf3mm06ValidateResultModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewFqf3mm06ValidateResult', { static: true }) modal: ModalDirective | undefined;
