...
import { AsyAdoAInPlanServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-ainplan-modal',
    templateUrl: './history-ainplan-modal.component.html' 
})
export class ViewHistoryAInPlanComponent extends AppComponentBase {
    @ViewChild('viewHistoryAInPlan', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'AsyAdoAInPlan')


    }

    getData(_id, _tableName) {
        this._service.getAsyAdoAInPlanHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getAsyAdoAInPlanHistory(
            this.Id,
            'AsyAdoAInPlan',
            '',
            this.paginationParams.skipCount,
