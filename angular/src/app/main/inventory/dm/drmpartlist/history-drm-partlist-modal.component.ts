...
@Component({
    selector: 'history-drm-partlist-modal',
    templateUrl: './history-drm-partlist-modal.component.html'
})
export class ViewHistoryDrmPartlistModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryDrmPartlistModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvDrmPartlist')
        console.log("is show")

    }

    getData(_id, _tableName) {
        this._service.getDrmPartListHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getDrmPartListHistory(
            this.Id,
            'InvDrmPartlist',
            '',
            this.paginationParams.skipCount,
