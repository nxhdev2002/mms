...
namespace prod.Frame.Andon
{
    ...
    [Table("FrmAdoFramePlanBMPV_T")]
    [Index(nameof(No), Name = "IX_FrmAdoFramePlanBMPV_T_No")]
    [Index(nameof(LotNo), Name = "IX_FrmAdoFramePlanBMPV_T_LotNo")]
    [Index(nameof(NoInLot), Name = "IX_FrmAdoFramePlanBMPV_T_NoInLot")]
    [Index(nameof(FrameId), Name = "IX_FrmAdoFramePlanBMPV_T_FrameId")]
    [Index(nameof(PlanMonth), Name = "IX_FrmAdoFramePlanBMPV_T_PlanMonth")]
    [Index(nameof(PlanDate), Name = "IX_FrmAdoFramePlanBMPV_T_PlanDate")]
    public class FrmAdoFramePlanBMPV_T : FullAuditedEntity<long>, IEntity<long>
    {
        ...
        public const int MaxMessagesErrorLength = 1000;
        ...
        [StringLength(MaxMessagesErrorLength)]
