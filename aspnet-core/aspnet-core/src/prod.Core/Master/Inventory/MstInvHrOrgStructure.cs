...
namespace prod.Master.Inventory
{
    ...
    [Table("MstInvHrOrgStructure")]
    //[Index(nameof(Hrid), Name = "IX_MstInvHrOrgStructure_Hrid")]
    [Index(nameof(IsActive), Name = "IX_MstInvHrOrgStructure_IsActive")]
    public class MstInvHrOrgStructure : FullAuditedEntity<System.Guid>, IEntity<System.Guid>
    {
