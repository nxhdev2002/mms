...
import { MstCmmDevanningCaseTypeServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-devanningcasetype-modal',
    templateUrl: './history-devanningcasetype-modal.component.html'
})
export class ViewHistoryDevanningCaseTypeModalComponent extends AppComponentBase {
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmDevanningCaseType')
    }

    getData(_id,_tableName){
        this._service.getMstCmmDevanningCaseTypeHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMstCmmDevanningCaseTypeHistory(
            this.id,
            'MstCmmDevanningCaseType',
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        )
