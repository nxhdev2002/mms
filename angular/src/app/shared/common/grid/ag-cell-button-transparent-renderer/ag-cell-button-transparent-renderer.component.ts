...
@Component({
  selector: 'ag-cell-button-transparent-renderer',
  templateUrl: './ag-cell-button-transparent-renderer.component.html',
  styleUrls: ['./ag-cell-button-transparent-renderer.component.less']
})
export class AgCellButtonTransparentRendererComponent implements ICellRendererAngularComp {
    ...
    get _ClassName() {
        if (typeof this.buttonDef.className === 'function') {
          return this.buttonDef.className(this.params);
        }
        return this.buttonDef.text
    }

    get _ClassNameTwo() {
        if (typeof this.buttonDefTwo.className === 'function') {
          return this.buttonDefTwo.className(this.params);
        }
        return this.buttonDefTwo.text
    }
    get _ClassNameTwo1() {
