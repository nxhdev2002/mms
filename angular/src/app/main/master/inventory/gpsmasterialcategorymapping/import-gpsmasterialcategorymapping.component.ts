...
@Component({
    selector: 'import-gpsmasterialcategorymapping',
    templateUrl: './import-gpsmasterialcategorymapping.component.html',
    styleUrls: ['../../../import-modal.less'],
})
export class ImportGpsMaterialCategoryMappingComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportMaterialCategoryMappingFromExcel';
            { }
    }
    ngOnInit() {
