...
import { MstInvDevanningCaseTypeServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-devaningcasetype-modal',
    templateUrl: './history-devaningcasetype-modal.component.html'
})
export class ViewHistoryDevanningCaseTypeModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryDevanningCaseTypeInventoryModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstInvDevanningCaseType')
    }

    getData(_id,_tableName){
        this._service.getMstInvDevanningCaseTypeHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMstInvDevanningCaseTypeHistory(
            this.id,
            'MstInvDevanningCaseType',
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        )
