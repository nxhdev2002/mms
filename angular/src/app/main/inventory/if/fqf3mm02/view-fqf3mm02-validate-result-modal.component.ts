...
@Component({
    templateUrl: './view-fqf3mm02-validate-result-modal.component.html',
    selector: 'view-fqf3mm02-validate-result-modal'
})
export class ViewFqf3mm02ValidateResultModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewValidateFqf3mm02Validate', { static: true }) modal: ModalDirective | undefined;
    ...
    show(postingDateFrom?: any,postingDateTo?: any): void {
        ...
        this.isLoading = true;
        this._service.getInvInterfaceFQF3MM02ValidateResult(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getInvInterfaceFQF3MM02ValidateResult(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDateTo),
            '',
            this.paginationParams.skipCount,
    ...
    exportToExcel(e): void {
        ...
        this._service.getValidateResult_FQF3MM02ToExcel(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDateTo)
