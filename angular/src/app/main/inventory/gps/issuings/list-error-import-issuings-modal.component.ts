...
@Component({
    selector: 'list-error-import-issuings-modal',
    templateUrl: './list-error-import-issuings-modal.component.html',
    styleUrls: ['./list-error-import-issuings-modal.component.less'],
})
export class ListErrorImportGpsIssuingsComponent extends AppComponentBase {
    ...
    constructor(injector: Injector,
        ...
        private _import: ImportInvGpsIssuingsComponent
    ) {
        super(injector);
        { }
    }
