...
@Component({
    selector: 'import-gps-cost-center',
    templateUrl: './import-gpscostcenter.component.html',
    styleUrls: ['../../../import-modal.less'],
})
export class ImportGpsCostCenterComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportGpsCostCenterFromExcel';
            { }
    }
    ngOnInit() {
