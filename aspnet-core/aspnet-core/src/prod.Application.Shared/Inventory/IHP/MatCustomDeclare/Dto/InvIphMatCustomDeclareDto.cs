...
{
    public class InvIphMatCustomDeclareDto : EntityDto<long?>
    {
        public virtual int DToKhaiMDID { get; set; }
        public virtual decimal SOTK { get; set; }
    ...
    public class GetInvIphMatCustomDeclareInput : PagedAndSortedResultRequestDto
    {
        public virtual string SOTK { get; set; }

        public virtual DateTime? NGAY_DK_FROM { get; set; }

        public virtual DateTime? NGAY_DK_TO { get; set; }
    ...
    public class InvIphMatCustomDeclareDetailsDto : EntityDto<long?>
    {
    ...
    public class GetInvIphMatCustomDeclareDetailsInput : PagedAndSortedResultRequestDto
    {
        public virtual int DToKhaiMDID { get; set; }
    ...
    }public class GetInvIphMatCustomDeclareDetailsExcelInput 
    {
        public virtual int DToKhaiMDID { get; set; }
