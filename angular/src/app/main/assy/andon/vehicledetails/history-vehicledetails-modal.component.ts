...
import { AsyAdoVehicleDetailsServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-vehicledetails-modal',
    templateUrl: './history-vehicledetails-modal.component.html' 
})
export class ViewHistoryVehicleDetailsComponent extends AppComponentBase {
    @ViewChild('viewHistoryVehicleDetails', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'AsyAdoVehicleDetails')


    }

    getData(_id, _tableName) {
        this._service.getAsyAdoVehicleDetailsHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getAsyAdoVehicleDetailsHistory(
            this.Id,
            'AsyAdoVehicleDetails',
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        )
