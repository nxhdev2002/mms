...
import { InvGpsMaterialServiceProxy, MstCmmMMCheckingRuleServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-mmcheckingrule-modal',
    templateUrl: './history-mmcheckingrule-modal.component.html'
})
export class ViewHistorymmcheckingruleModalComponent extends AppComponentBase {
    @ViewChild('viewHistorymmcheckingruleModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmMMCheckingRule')
    }

    getData(_id,_tableName){
        this._service.getMstCmmMMCheckingRuleHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMstCmmMMCheckingRuleHistory(
            this.id,
