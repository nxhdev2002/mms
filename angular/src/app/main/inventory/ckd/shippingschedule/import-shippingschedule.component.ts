...
@Component({
    selector: 'import-shippingschedule',
    templateUrl: './import-shippingschedule.component.html',
    styleUrls: ['../../../import-modal.less'],
})
export class ImportShippingScheduleComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportInvShippingScheduleFromExcel';
            { }
    }
    ngOnInit() {
