...
import { PtsAdoPaintingProgressDto, PtsAdoPaintingProgressServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './paintingprogress.component.html',
    styleUrls: ['./paintingprogress.component.less'],
})
export class PaintingProgressComponent extends AppComponentBase implements OnInit {
    @ViewChild('createOrEditModalPaintingProgress', { static: true }) createOrEditModalPaintingProgress:| CreateOrEditPaintingProgressModalComponent| undefined;
    ...
    selectedRow: PtsAdoPaintingProgressDto = new PtsAdoPaintingProgressDto();
    saveSelectedRow: PtsAdoPaintingProgressDto = new PtsAdoPaintingProgressDto();
    datas: PtsAdoPaintingProgressDto = new PtsAdoPaintingProgressDto();
    ...
    constructor(
        injector: Injector,
        private _service: PtsAdoPaintingProgressServiceProxy,
        ...
        this.defaultColDefs = [
            ...
            },
            {
                ...
                field: 'lastConveyerRun', valueGetter: (params) => this.pipe.transform(params.data?.lastConveyerRun, 'dd/MM/yyyy'),
                width: 130,
            },
            {
            ...
            },
            {
                ...
                buttonDefTwo: {
                    text: function (params: any) {
                        if (params.data?.weldTransfer == "Y") {
                            return 'Active'
                        }
                        else if (params.data?.weldTransfer == "N") {
                            return 'InActive'
                        }
                        return '';
                    },
    ...
    searchDatas_WOBS1(){
        this.scanLocation = 'W_OBS1',
        this.processGroup = 0
        this.searchDatas();
    }

    searchDatas_Loading1(){
        this.scanLocation = 'Loading1',
        this.processGroup = 1
        this.searchDatas();
    }

    searchDatas_PREPARAT1(){
        this.scanLocation = 'PREPARAT1',
        this.processGroup = 2
        this.searchDatas();
    }

    searchDatas_INLINE1(){
        this.scanLocation = 'INLINE1',
        this.processGroup = 3
        this.searchDatas();
    }

    searchDatas_REPAIR1(){
        this.scanLocation = 'REPAIR1',
        this.processGroup = 4
        this.searchDatas();
    }

    searchDatas_T_OBS_I1(){
        this.scanLocation = 'T_OBS_I1',
        this.processGroup = 5
        this.searchDatas();
    }
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => PtsAdoPaintingProgressDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new PtsAdoPaintingProgressDto();
    ...
    deleteRow(system: PtsAdoPaintingProgressDto): void {
    ...
    exportToExcel(): void {
        this.isLoading = true;
        this._service.getPaintingProgressToExcel(
            this.bodyNo,
            this.model,
            this.lotNo,
            this.scanLocation,
