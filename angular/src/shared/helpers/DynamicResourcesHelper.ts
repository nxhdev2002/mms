...
export class DynamicResourcesHelper {
    ...
    static loadStyles(): Promise<any> {
        ...
        let styleUrls = [
            // AppConsts.appBaseUrl + '/styles.css',
            // AppConsts.appBaseUrl + '/assets/metronic/themes/' + theme + '/css/style.bundle' + cssPostfix.replace('-', '.') + '.css',
            AppConsts.appBaseUrl + '/assets/metronic/themes/' + theme + '/plugins/global/plugins.bundle' + cssPostfix.replace('-', '.') + '.css',
            AppConsts.appBaseUrl + '/assets/primeng/themes/mdc-' + (ThemeHelper.darkMode() ? 'dark' : 'light') + '-indigo/theme.css', // PrimeNG Dark mode styles
        ...
        // styleLoaderService.load(AppConsts.appBaseUrl + '/styles.css');
