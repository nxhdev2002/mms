...
import { GetGradebyPartListDto, GetPartListGradeDto, InvCkdPartGradeDto, InvCkdPartListDto, InvCkdPartListServiceProxy, InvGpsPartListServiceProxy, MstLgaBp2PartListServiceProxy, ValidatePartListDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'view-gps-validate-partlist-modal',
    templateUrl: './view-gps-validate-partlist-modal.component.html'
})
export class ViewGpsValidatePartListModalComponent extends AppComponentBase {
    @ViewChild('viewGpsValidatePartListModal', { static: true }) modal: ModalDirective | undefined;
    ...
    constructor(
        ...
        this.validateColDef = [
            ...
            {
                headerName: this.l('PartNoNormalized'),
                headerTooltip: this.l('PartNoNormalized'),
    ...
    show(): void {
        this.isLoading = true;
        this._service.getValidateInvGpsPartList(
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getValidateInvGpsPartList(
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        );
    ...
    exportToExcel(e): void {
        ...
        this._service.getValidateInvGpsPartListExcel(
        ).subscribe((result) => {
            setTimeout(() => {
