...
namespace prod.Frame.Andon
{
	...
	[Table("FrmAdoFramePlan")]
	[Index(nameof(No), Name = "IX_FrmAdoFramePlan_No")]
	[Index(nameof(LotNo), Name = "IX_FrmAdoFramePlan_LotNo")]
	[Index(nameof(NoInLot), Name = "IX_FrmAdoFramePlan_NoInLot")]
	[Index(nameof(FrameId), Name = "IX_FrmAdoFramePlan_FrameId")]
	[Index(nameof(PlanMonth), Name = "IX_FrmAdoFramePlan_PlanMonth")]
	[Index(nameof(PlanDate), Name = "IX_FrmAdoFramePlan_PlanDate")]
	public class FrmAdoFramePlan : FullAuditedEntity<long>, IEntity<long>
	{
