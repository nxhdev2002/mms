...
import { MstCmmExchangeRateServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-exchangerate-modal',
    templateUrl: './history-exchangerate-modal.component.html'
})
export class ViewHistoryExchangeRateModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryExchangeRateModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmExchangeRate')
    }

    getData(_id,_tableName){
        this._service.getMstCmmExchangeRateHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMstCmmExchangeRateHistory(
            this.id,
            'MstCmmExchangeRate',
            '',
            this.paginationParams.skipCount,
