...
namespace prod.Frame.Andon
{
	...
	[Table("FrmAdoFramePlanA1")]
	[Index(nameof(No), Name = "IX_FrmAdoFramePlanA1_No")]
	[Index(nameof(LotNo), Name = "IX_FrmAdoFramePlanA1_LotNo")]
	[Index(nameof(NoInLot), Name = "IX_FrmAdoFramePlanA1_NoInLot")]
	[Index(nameof(FrameId), Name = "IX_FrmAdoFramePlanA1_FrameId")]
	[Index(nameof(PlanMonth), Name = "IX_FrmAdoFramePlanA1_PlanMonth")]
	[Index(nameof(PlanDate), Name = "IX_FrmAdoFramePlanA1_PlanDate")]
	public class FrmAdoFramePlanA1 : FullAuditedEntity<long>, IEntity<long>
	{
