...
@Component({
    templateUrl: './frameplanbmpv.component.html',
    styleUrls: ['./frameplanbmpv.component.less'],
})
export class FramePlanBMPVComponent extends AppComponentBase implements OnInit {
    @ViewChild('paginator', { static: true }) paginator: Paginator;
    @ViewChild('importExcelModal', { static: true }) importExcelModal:| ImportFramePlanBMPVComponent| undefined;
    ...
    selectedRow: FrmAdoFramePlanBMPVDto = new FrmAdoFramePlanBMPVDto();
    saveSelectedRow: FrmAdoFramePlanBMPVDto = new FrmAdoFramePlanBMPVDto();
    datas: FrmAdoFramePlanBMPVDto = new FrmAdoFramePlanBMPVDto();
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => FrmAdoFramePlanBMPVDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new FrmAdoFramePlanBMPVDto();
    ...
    deleteRow(system: FrmAdoFramePlanBMPVDto): void {
    ...
    exportToExcel(): void {
        ...
        this._service.getFramePlanBMPVToExcel(
            this.model,
            this.lotNo,
            this.bodyNo,
            this.vinNo,
