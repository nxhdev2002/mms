...
import { FrmAdoFramePlanServiceProxy } from '@shared/service-proxies/service-proxies';
import { FramePlanComponent } from './frameplan.component';

@Component({
  selector: 'import-frameplan-modal',
  templateUrl: './import-frameplan-modal.component.html',
  styleUrls: ['./import-frameplan-modal.component.less']
})
export class ImportFramePlanComponent   extends AppComponentBase {
    ...
    constructor(
      ...
      private _framePlan: FramePlanComponent
    ) {
      super(injector);
      this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportFramePlanFromExcel';
      {}
    }
    ngOnInit() {
    ...
    upload() {
        ...
        this._httpClient
            ...
            .subscribe(response => {
                if (response.success ) {
                    this.mergeFramePlan(response.result.framPlan.result[0].guid);
