...
namespace prod.Master.Frame
{
	...
	[Table("MstFrmProcess")]
	[Index(nameof(ProcessSeq), Name = "IX_MstFrmProcess_ProcessSeq")]
	[Index(nameof(ProcessCode), Name = "IX_MstFrmProcess_ProcessCode")]
	[Index(nameof(ProcessSubgroup), Name = "IX_MstFrmProcess_ProcessSubgroup")]
	[Index(nameof(SubgroupName), Name = "IX_MstFrmProcess_SubgroupName")]
	public class MstFrmProcess : FullAuditedEntity<long>, IEntity<long>
	{
