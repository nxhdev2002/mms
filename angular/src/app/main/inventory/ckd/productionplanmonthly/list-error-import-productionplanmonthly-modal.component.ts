...
@Component({
    selector: 'list-error-import-productionplanmonthly',
    templateUrl: './list-error-import-productionplanmonthly-modal.component.html',
    styleUrls: ['./list-error-import-productionplanmonthly-modal.component.less'],
})
export class ListErrorImportProductionPlanMonthlyComponent extends AppComponentBase {
    ...
    constructor(injector: Injector,
        ...
        private _import: ImportProductionPlanMonthlyComponent
    ) {
        super(injector);
        { }
    }
