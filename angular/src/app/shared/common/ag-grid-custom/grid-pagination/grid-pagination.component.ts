...
export class GridPaginationComponent extends AppComponentBase
    ...
    @Input() paginationParams: PaginationModel = { pageNum: 1, pageSize: 500, totalCount: 0, totalPage: 1 };
    ...
    get fromRecord() {
        ...
        return (
            ((this.paginationParams.pageNum - 1) < 0) ? 0:(this.paginationParams.pageNum - 1) * this.paginationParams.pageSize + 1
        );
    }
