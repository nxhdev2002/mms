...
@Component({
    templateUrl: './view-fqf3mm01-validate-modal.component.html',
    selector: 'view-fqf3mm01-validate-modal'
})
export class ViewFqf3mm01ValidateModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewFqf3mm01Validate', { static: true }) modal: ModalDirective | undefined;
    ...
    show(lineOffDatetimeFrom?: any, lineOffDatetimeTo?: any): void {
        ...
        this.isLoading = true;
        this._service.getInvInterfaceFQF3MM01Validate(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getInvInterfaceFQF3MM01Validate(
            this._dateTimeService.convertToDatetime(this.lineOffDatetimeFrom),
            this._dateTimeService.convertToDatetime(this.lineOffDatetimeTo),
            '',
            this.paginationParams.skipCount,
    ...
    exportToExcel(e): void {
        ...
        this._service.getValidate_FQF3MM01ToExcel(
            this._dateTimeService.convertToDatetime(this.lineOffDatetimeFrom),
            this._dateTimeService.convertToDatetime(this.lineOffDatetimeTo),
        ).subscribe((result) => {
            setTimeout(() => {
