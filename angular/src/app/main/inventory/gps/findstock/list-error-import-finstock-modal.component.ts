...
import { InvDrmStockPartServiceProxy, InvGpsFinStockServiceProxy, InvGpsIssuingServiceProxy} from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'list-error-import-finstock-modal',
    templateUrl: './list-error-import-finstock-modal.component.html',
    styleUrls: ['./list-error-import-finstock-modal.component.less'],
})
export class ListErrorImportGpsFinStockComponent extends AppComponentBase {
