...
import { InvCkdPartGradeDto, MstCmmLotCodeGradeServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-gradecolor-modal',
    templateUrl: './history-gradecolor-modal.component.html'
})
export class ViewHistoryGradeColorModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryGradeColorModal', { static: true }) modal: ModalDirective | undefined
    ...
    listData: any;
    // selectedRow: InvCkdGradeColorDto;
    rowdata: any[];
    ...
    //     this.isLoading = true
    //     this.allRowHeaders = [];
    //     this.getData(id,'MstCmmLotCodeGrade')
    ...
    show(id, type): void {
        ...
        switch (type) {
            case 'C':
                this.tableName = 'MstCmmLotCodeGrade';
                break;
            case 'CD':
                this.tableName = 'MstCmmColor';
                break;
            default:
                break;
        }
        this.isLoading = true
        this.allRowHeaders = [];
        if (type == 'C') { this.getData() }
        else if (type == 'CD') { this.getData() }
    }

    getData() {
        this._service.getMstCmmGradeColorHistory(
            this.recordId,
            this.tableName,
            '',
    ...
    //     return this._service.getMstCmmGradeColorHistory(
    //         this.Id,
    //         'MstCmmLotCodeGrade',
    //         '',
    //         this.paginationParams.skipCount,
