...
import { InvCkdPartGradeDto, InvCkdProductionMappingDto, InvProductionMappingServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-productionmapping-modal',
    templateUrl: './history-productionmapping-modal.component.html'
})
