...
namespace prod.LogW.Pup
{
	...
	[Table("LgwPupPxPUpPlan")]
	[Index(nameof(WorkingDate), Name = "IX_LgwPupPxPUpPlan_WorkingDate")]
	[Index(nameof(Shift), Name = "IX_LgwPupPxPUpPlan_Shift")]
	[Index(nameof(CaseNo), Name = "IX_LgwPupPxPUpPlan_CaseNo")]
	[Index(nameof(IsActive), Name = "IX_LgwPupPxPUpPlan_IsActive")]
	public class LgwPupPxPUpPlan : FullAuditedEntity<long>, IEntity<long>
	{
