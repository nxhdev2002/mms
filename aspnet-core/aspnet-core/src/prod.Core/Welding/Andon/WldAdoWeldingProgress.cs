...
namespace prod.Welding.Andon
{
	...
	[Table("WldAdoWeldingProgress")]
	[Index(nameof(ScanningId), Name = "IX_WldAdoWeldingProgress_ScanningId")]
	[Index(nameof(BodyNo), Name = "IX_WldAdoWeldingProgress_BodyNo")]
	[Index(nameof(Color), Name = "IX_WldAdoWeldingProgress_Color")]
	[Index(nameof(ProcessGroup), Name = "IX_WldAdoWeldingProgress_ProcessGroup")]
	[Index(nameof(Model), Name = "IX_WldAdoWeldingProgress_Model")]
	[Index(nameof(LotNo), Name = "IX_WldAdoWeldingProgress_LotNo")]
	[Index(nameof(NoInLot), Name = "IX_WldAdoWeldingProgress_NoInLot")]
	[Index(nameof(SequenceNo), Name = "IX_WldAdoWeldingProgress_SequenceNo")]
	[Index(nameof(IsPaintOut), Name = "IX_WldAdoWeldingProgress_IsPaintOut")]
	[Index(nameof(IsActive), Name = "IX_WldAdoWeldingProgress_IsActive")]
	public class WldAdoWeldingProgress : FullAuditedEntity<long>, IEntity<long>
	{
