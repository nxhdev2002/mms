...
import { InvCkdPartGradeDto, InvCkdProdPlanDailyDto, InvCkdProdPlanDailyServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-prodplandaily-modal',
    templateUrl: './history-prodplandaily-modal.component.html'
})
export class ViewHistoryProdPlanDailyModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryProdPlanDailyModal', { static: true }) modal: ModalDirective | undefined
    ...
    listData: any;
    selectedRow: InvCkdProdPlanDailyDto;
    rowdata: any[];
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvCkdProdPlanDaily')


    }

    getData(_id, _tableName) {
        this._service.getProdPlanDailyHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getProdPlanDailyHistory(
            this.Id,
            'InvCkdProdPlanDaily',
            '',
            this.paginationParams.skipCount,
