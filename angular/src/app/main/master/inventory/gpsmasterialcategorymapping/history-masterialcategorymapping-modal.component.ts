...
@Component({
    selector: 'history-masterialcategorymapping-modal',
    templateUrl: './history-masterialcategorymapping-modal.component.html'
})
export class ViewHistoryMaterialCategoryMappingModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryMaterialCategoryMappingModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstGpsMaterialCategoryMapping')
    }

    getData(_id,_tableName){
        this._service.getMaterialCategoryMappingHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getMaterialCategoryMappingHistory(
            this.id,
