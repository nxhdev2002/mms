...
import { LoggingResponseDetailsOnlBudgetCheckDto, IF_FQF3MM07ServiceProxy, BusinessDataDto, IF_FQF3MM03ServiceProxy, GetIF_FQF3MM01_VALIDATE, IF_FQF3MM01ServiceProxy, GetIF_FQF3MM07_VALIDATE } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './view-fqf3mm07-validate-result-modal.component.html',
    selector: 'view-fqf3mm07-validate-result-modal'
})
export class ViewFqf3mm07ValidateResultModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewFqf3mm07ValidateResult', { static: true }) modal: ModalDirective | undefined;
    ...
    selectedRow: GetIF_FQF3MM07_VALIDATE = new GetIF_FQF3MM07_VALIDATE();
    saveSelectedRow: GetIF_FQF3MM07_VALIDATE = new GetIF_FQF3MM07_VALIDATE();
    ...
    show(postingDateFrom?: any, postingDate?: any): void {
        ...
        this.isLoading = true;
        this._service.getInvInterfaceFQF3MM07ValidateResult(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getInvInterfaceFQF3MM07ValidateResult(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDate),
            '',
            this.paginationParams.skipCount,
    ...
    exportToExcel(e): void {
        ...
        this._service.getFQF3MM07VALIDATEResultToExcel(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDate),
        ).subscribe((result) => {
            setTimeout(() => {
