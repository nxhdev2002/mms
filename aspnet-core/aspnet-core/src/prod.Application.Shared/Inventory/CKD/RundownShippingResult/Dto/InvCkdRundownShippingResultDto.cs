...
namespace prod.Inventory.CKD.RundownShippingResult.Dto
{
    public class InvCkdRundownShippingResultDto : EntityDto<long?>
    {
    ...
    public class GetStockRundownShippingResultInput : PagedAndSortedResultRequestDto
    {
    ...
    public class GetStockRundownShippingResultExportInput
    {
        public virtual string PartNo { get; set; }
