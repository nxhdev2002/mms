...
import { InvCkdSmqdServiceProxy, InvPioPartListServiceProxy } from '@shared/service-proxies/service-proxies';
import { ListErrorImportInvPioPartListComponent } from './list-error-import-part-list-modal.component';

@Component({
    selector: 'import-partlist',
    templateUrl: './import-partlist.component.html',
...
export class ImportPartListComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportPioPartListFromExcel';
            { }
    }
    ngOnInit() {
