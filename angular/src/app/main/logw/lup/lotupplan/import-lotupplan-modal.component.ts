...
import { LgwLupLotUpPlanServiceProxy, MstLgwUnpackingPartServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'app-import-lotupplan-modal',
    templateUrl: './import-lotupplan-modal.component.html',
    styleUrls: ['./import-lotupplan-modal.component.less']
})
export class ImportLotupplanModalComponent   extends AppComponentBase {
    ...
    constructor(
      ...
      private _lotupplan: LotUpPlanComponent
    ) {
      super(injector);
      this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Prod/ImportLotUpPlanFromExcel';
      {}
    }
    ngOnInit() {
    ...
    mergeUnpackingPart(guid) {
        this.isLoading = true;
        this._service.mergeDataLotUpPlan(guid)
            .pipe(
                finalize(() => {
                    this.isLoading = false;
                })
