...
import { InvCkdPartListDto, InvCkdPartListServiceProxy, InvCkdContainerListDto, InvCkdContainerListServiceProxy} from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-containerlist-modal',
    templateUrl: './history-containerlist-modal.component.html'
})
export class ViewHistoryContainerListModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryContainerListModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvCkdContainerList')
    }

    getData(_id,_tableName){
        this._service.getContainerListHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
		return this._service.getContainerListHistory(
            this.id,
            'InvCkdContainerList',
            '',
            this.paginationParams.skipCount,
