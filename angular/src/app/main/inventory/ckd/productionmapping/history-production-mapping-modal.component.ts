...
import { InvCkdPartGradeDto, InvCkdProductionMappingDto, InvCkdProductionMappingServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-production-mapping-modal',
    templateUrl: './history-production-mapping-modal.component.html'
})
export class ViewHistoryProductionMappingModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryProductionMappingModal', { static: true }) modal: ModalDirective | undefined
    ...
    listData: any;
    selectedRow: InvCkdProductionMappingDto;
    rowdata: any[];
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvCkdProductionMapping')


    }

    getData(_id, _tableName) {
        this._service.getProductionMappingHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getProductionMappingHistory(
            this.Id,
            'InvCkdProductionMapping',
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        )
