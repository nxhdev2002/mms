...
@Component({
    selector: 'history-weldingplan-modal',
    templateUrl: './history-weldingplan-modal.component.html' 
})
export class ViewHistoryWeldingPlanComponent extends AppComponentBase {
    @ViewChild('viewHistoryWeldingPlan', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'WldAdoWeldingPlan')


    }

    getData(_id, _tableName) {
        this._service.getWldAdoWeldingPlanHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getWldAdoWeldingPlanHistory(
            this.Id,
            'WldAdoWeldingPlan',
            '',
            this.paginationParams.skipCount,
