...
{
    /// <inheritdoc />
    public partial class updateInvGpsStockRundownTransactionTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "InvGpsStockRundown",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvGpsStockRundown", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "InvGpsStockRundownTransaction",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvGpsStockRundownTransaction", x => x.Id);
                });
        }
