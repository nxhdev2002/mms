...
import { MstCmmProductTypeDto, MstCmmProductTypeServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class ProductTypeComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MstCmmProductTypeDto = new MstCmmProductTypeDto();
    saveSelectedRow: MstCmmProductTypeDto = new MstCmmProductTypeDto();
    datas: MstCmmProductTypeDto = new MstCmmProductTypeDto();
    pending: string = '';
    ...
    constructor(
        injector: Injector,
        private _service: MstCmmProductTypeServiceProxy,
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => MstCmmProductTypeDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new MstCmmProductTypeDto();
    ...
    exportToExcel(e): void {
       ...
       this.fn.exportLoading(e, true);
        ...
        this._service.getProductTypeToExcel(
            this.code,
            this.name,
            this.isActive
        )
