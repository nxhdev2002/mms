...
import { InvCkdPhysicalStockPeriodServiceProxy, InvCkdContainerListServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    ...
    templateUrl: './export-excel-containerlist-modal.component.html',
    styleUrls: ['./export-excel-containerlist-modal.component.less'],
})
export class ExportExcelContainerListComponent extends AppComponentBase {
    ...
    exportToExcel() {
        ...
        this.disable = true;
        this._service.getContainerListByPeriodToExcel(this.id)
            .subscribe((result) => {
