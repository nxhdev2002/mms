...
import { LgaSpsStockDto, LgaSpsStockServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class StockComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: LgaSpsStockDto = new LgaSpsStockDto();
    saveSelectedRow: LgaSpsStockDto = new LgaSpsStockDto();
    datas: LgaSpsStockDto = new LgaSpsStockDto();
    ...
    supplierNo: string = '';
    backNo: string = '';
    spsRackAddress: string = '';
    pcRackAddress: string = '';
    rackCapBox: number = 0;
    pcPicKingMember: number = 0;
    ekbQty: number = 0;
    stockQty: number = 0;
    boxQty: number = 0;
    process: string = '';
    ...
    constructor(
        injector: Injector,
        private _service: LgaSpsStockServiceProxy,
        ...
        this.defaultColDefs = [
            ...
            {
                headerName: this.l('Sps Rack Address'),
                headerTooltip: this.l('Sps Rack Address'),
                field: 'spsRackAddress',
                flex: 1
            },
            {
            ...
            {
                headerName: this.l('Pc PicKing Member'),
                headerTooltip: this.l('Pc PicKing Member'),
                field: 'pcPicKingMember',
                flex: 1
            },
            {
                headerName: this.l('Ekb Qty'),
                headerTooltip: this.l('Ekb Qty'),
                field: 'ekbQty',
                flex: 1
            },
            {
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => LgaSpsStockDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new LgaSpsStockDto();
    ...
    deleteRow(system: LgaSpsStockDto): void {
