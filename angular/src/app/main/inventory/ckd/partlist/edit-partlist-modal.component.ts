...
import { GetGradebyPartListDto, GetPartListGradeDto, InvCkdPartGradeDto, InvCkdPartListDto, InvCkdPartListServiceProxy, MstLgaBp2PartListServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'edit-partlist-modal',
    templateUrl: './edit-partlist-modal.component.html',
    styleUrls: ['./edit-partlist-modal.component.less']
})
export class EditPartListModalComponent extends AppComponentBase {
    ...
    save(): void {
        ...
        if (this.checkValidate) {
            ...
            this.isLoading = true;
            this._service.partListEdit(input)
