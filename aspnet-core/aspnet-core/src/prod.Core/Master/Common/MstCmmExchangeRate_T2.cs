...
namespace prod.Master.Common
{
    ...
    [Table("MstCmmExchangeRate_T2")]
    [Index(nameof(ExchangeDate), Name = "IX_MstCmmExchangeRate_T2_ExchangeDate")]
    [Index(nameof(IsActive), Name = "IX_MstCmmExchangeRate_T2_IsActive")]
    public class MstCmmExchangeRate_T2 : FullAuditedEntity<long>, IEntity<long>
    {
