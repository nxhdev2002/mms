...
import { LgaPlcSignalDto, LgaPlcSignalServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class LogAPlcSignalComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: LgaPlcSignalDto = new LgaPlcSignalDto();
    saveSelectedRow: LgaPlcSignalDto = new LgaPlcSignalDto();
    datas: LgaPlcSignalDto = new LgaPlcSignalDto();
    ...
    constructor(
        injector: Injector,
        private _service: LgaPlcSignalServiceProxy,
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => LgaPlcSignalDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new LgaPlcSignalDto();
