...
namespace prod.Inventory.CKD
{
    ...
    [Table("InvCkdPhysicalConfirmLot")]
    [Index(nameof(ModelCode), Name = "IX_InvCkdPhysicalConfirmLot_ModelCode")]

    public class InvCkdPhysicalConfirmLot : FullAuditedEntity<long>, IEntity<long>
    {
