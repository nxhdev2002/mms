...
namespace prod.Migrations
{
    ...
    [Migration("20230724071849_update_MstCmmMMCheckingRule_MstCmmMMValidationResult_Table")]
    partial class updateMstCmmMMCheckingRuleMstCmmMMValidationResultTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("prod.Master.Cmm.MstCmmMMValidationResult", b =>
                {
                    ...
                    b.Property<string>("Lastvalidationid")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
