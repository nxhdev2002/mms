...
import { GetGradebyPartListDto, GetPartListGradeDto, GetPartListGradePartListInlDto, InvCkdPartGradeDto, InvCkdPartListDto, InvCkdPartListServiceProxy, InvPartListOffServiceProxy, InvPioPartListInlServiceProxy, MstLgaBp2PartListServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'edit-partlistoff-modal',
    templateUrl: './edit-partlistoff-modal.component.html',
    styleUrls: ['./edit-partlistoff-modal.component.less']
})
export class EditPartListOffModalComponent extends AppComponentBase {
    @ViewChild('editPartListOffModal', { static: true }) modal: ModalDirective | undefined;
    ...
    save(): void {
        ...
        if (this.checkValidate) {
            ...
            this.isLoading = true;
            this._service.partListOffEdit(input)
