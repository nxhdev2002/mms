...
import { InvCkdPartGradeDto, MstCmmLookupServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-lookup-modal',
    templateUrl: './history-lookup-modal.component.html' 
})
export class ViewHistoryMstCmmLookupModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryMstCmmLookupModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'MstCmmLookup')


    }

    getData(_id, _tableName) {
        this._service.getMstCmmLookupHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getMstCmmLookupHistory(
            this.Id,
            'MstCmmLookup',
            '',
            this.paginationParams.skipCount,
