...
import { MstGpsUomDto, MstGpsUomServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class UomComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MstGpsUomDto = new MstGpsUomDto();
    saveSelectedRow: MstGpsUomDto = new MstGpsUomDto();
    datas: MstGpsUomDto = new MstGpsUomDto();
    ...
    constructor(
        injector: Injector,
        private _service: MstGpsUomServiceProxy,
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => MstGpsUomDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new MstGpsUomDto();
    ...
    deleteRow(system: MstGpsUomDto): void {
