...
import { LoggingResponseDetailsOnlBudgetCheckDto, IF_FQF3MM07ServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class ViewLoggingResponseBudgetCheckComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('viewRequestBudgetCheck', { static: true }) viewRequestBudgetCheck: ViewRequestBudgetCheckComponent | undefined;
    ...
    show(documentNo): void {
        ...
        this._service.getViewLoggingResponseDetailsOnlBudgetCheck(
            this.documentNo,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getViewLoggingResponseDetailsOnlBudgetCheck(
            this.documentNo,
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
    ...
    showRequest(){
        ...
        this.viewRequestBudgetCheck.show(this.logId);
    }
