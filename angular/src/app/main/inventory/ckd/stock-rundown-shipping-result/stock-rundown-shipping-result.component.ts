...
import { InvCkdRundownShippingResultServiceProxy, InvGpsStockRundownDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './stock-rundown-shipping-result.component.html',
})
export class StockRundownShippingResultComponent extends AppComponentBase implements OnInit {
    ...
    constructor(
        injector: Injector,
        private _service: InvCkdRundownShippingResultServiceProxy,
    ...
    exportToExcel(e): void {
        this.fn.exportLoading(e, true);
        this._service.getExportShipResultRundownToExcel(
            this.partNo,
            this.p_CfcCode,
            this.p_SupplierCode
        )
