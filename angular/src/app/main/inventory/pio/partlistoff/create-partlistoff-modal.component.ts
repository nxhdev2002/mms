...
import { GetGradebyPartListDto, GetPartListGradeDto, InvPartListOffServiceProxy, InvPioPartListInlDto, InvPioPartListInlServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'create-partlistoff-modal',
    templateUrl: './create-partlistoff-modal.component.html',
    styleUrls: ['./create-partlistoff-modal.component.less']
})
export class CreatePartListOffModalComponent extends AppComponentBase {
    @ViewChild('addPartListOffModal', { static: true }) modal: ModalDirective | undefined;
    ...
    constructor(
        ...
        private _partList: PioPartListOffComponent
    ) {
        super(injector);
        this.partListColDef = [
            {
    ...
    save(): void {
        ...
        for (var i = 0; i < this._listGradeCheck.length; i++) {
            ...
            // if(this._listGradeCheck[i].shop == null || this._listGradeCheck[i].shop == ''){
        ...
        if (this.checkValidate) {
            ...
            this.isLoading = true;
            this._service.partListOffInsert(input)
