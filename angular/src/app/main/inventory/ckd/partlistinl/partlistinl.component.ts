...
import { InvPioPartGradeInlDto, InvPioPartListInlDto, InvPioPartListInlServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './partlistinl.component.html',
    styleUrls: ['./partlistinl.component.less'],
})
export class PioPartListInlComponent extends AppComponentBase implements OnInit {
