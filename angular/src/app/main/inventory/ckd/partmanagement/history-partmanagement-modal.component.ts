...
import { InvCkdPartManagementServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-partmanagement-modal',
    templateUrl: './history-partmanagement-modal.component.html'
})
export class ViewHistoryPartManagementModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryPartManagementModal', { static: true }) modal: ModalDirective | undefined
    ...
    show(id): void {
        ...
        this.isLoading = true
        this.allRowHeaders = [];
        this.getData(id,'InvCkdInvoiceDetails')


    }

    getData(_id, _tableName) {
        this._service.getPartManagementHistory(
            _id,
            _tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getPartManagementHistory(
            this.Id,
            'InvCkdInvoiceDetails',
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
        )
