...
namespace prod.Plan.Ccr
{
	...
	[Table("PlnCcrProductionPlan")]
	[Index(nameof(Shop), Name = "IX_PlnCcrProductionPlan_Shop")]
	[Index(nameof(LotNo), Name = "IX_PlnCcrProductionPlan_LotNo")]
	[Index(nameof(NoInLot), Name = "IX_PlnCcrProductionPlan_NoInLot")]
	public class PlnCcrProductionPlan : FullAuditedEntity<long>, IEntity<long>
	{
