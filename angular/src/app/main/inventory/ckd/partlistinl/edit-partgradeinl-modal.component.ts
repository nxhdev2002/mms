...
import { GetGradebyPartListDto, InvCkdPartGradeDto, InvCkdPartListServiceProxy, InvPioPartGradeInlDto, InvPioPartListInlServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'edit-partgradeinl-modal',
    templateUrl: './edit-partgradeinl-modal.component.html',
    styleUrls: ['./edit-partgradeinl-modal.component.less']
})
export class EditPartGradeInlModalComponent extends AppComponentBase {
    @ViewChild('editPartGradeInlModal', { static: true }) modal: ModalDirective | undefined;
    ...
    show(rowdata?: InvPioPartGradeInlDto, rowDataPartGrade?: any): void {
        this.bodyColorList = [];
        this.gradeListc = [];
        this.colorList = [];
        this.gradeLists1 = [];
