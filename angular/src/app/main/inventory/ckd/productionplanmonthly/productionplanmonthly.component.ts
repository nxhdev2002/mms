...
import { InvCkdProductionPlanMonthlyDto, InvCkdProductionPlanMonthlyServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './productionplanmonthly.component.html',
})
export class ProductionPlanMonthlyComponent extends AppComponentBase implements OnInit {
    @ViewChild('paginator', { static: true }) paginator: Paginator;
    @ViewChild('importExcelModal', { static: true }) importExcelModal:| ImportProductionPlanMonthlyComponent| undefined;
    ...
    selectedRow: InvCkdProductionPlanMonthlyDto = new InvCkdProductionPlanMonthlyDto();
    saveSelectedRow: InvCkdProductionPlanMonthlyDto = new InvCkdProductionPlanMonthlyDto();
    datas: InvCkdProductionPlanMonthlyDto = new InvCkdProductionPlanMonthlyDto();
    ...
    searchDatas(): void {
        ...
        this._service.getAllProductionPlanMonthly(
            this.cfc,
            this.grade,
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getAllProductionPlanMonthly(
            this.cfc,
            this.grade,
            this._dateTimeService.convertToDatetime(this.prodMonth),
			'',
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => InvCkdProductionPlanMonthlyDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new InvCkdProductionPlanMonthlyDto();
    ...
    exportToExcel(e): void {
        ...
        this._service.getInvCkdProdPlanMonthlyToExcel(
            this.cfc,
            this.grade,
            this._dateTimeService.convertToDatetime(this.prodMonth),
        )
