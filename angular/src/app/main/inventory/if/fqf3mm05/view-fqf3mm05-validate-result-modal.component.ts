...
@Component({
    templateUrl: './view-fqf3mm05-validate-result-modal.component.html',
    selector: 'view-fqf3mm05-validate-result-modal'
})
export class ViewFqf3mm05ValidateResultModalComponent extends AppComponentBase implements OnInit {
    @ViewChild('ViewFqf3mm05ValidateResult', { static: true }) modal: ModalDirective | undefined;
    ...
    show(postingDateFrom?: any, postingDateTo?: any): void {
        ...
        this.isLoading = true;
        this._service.getInvInterfaceFQF3MM05ValidateResult(
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getInvInterfaceFQF3MM05ValidateResult(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDateTo),
            '',
            this.paginationParams.skipCount,
    ...
    exportToExcel(e): void {
        ...
        this._service.getFQF3MM05VALIDATEResultToExcel(
            this._dateTimeService.convertToDatetime(this.postingDateFrom),
            this._dateTimeService.convertToDatetime(this.postingDateTo)
        ).subscribe((result) => {
            setTimeout(() => {
