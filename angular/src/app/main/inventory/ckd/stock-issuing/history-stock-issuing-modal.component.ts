...
import { InvCkdInvoiceDto, InvCkdInvoiceServiceProxy, InvCkdPartGradeDto, InvCkdPartListDto, InvCkdPartListServiceProxy, InvCkdStockIssuingDto, InvCkdStockIssuingServiceProxy } from '@shared/service-proxies/service-proxies'
...
@Component({
    selector: 'history-stock-issuing-modal',
    templateUrl: './history-stock-issuing-modal.component.html'
})
export class ViewHistoryStockIssuingModalComponent extends AppComponentBase {
    @ViewChild('viewHistoryStockIssuingModal', { static: true }) modal: ModalDirective | undefined
    ...
    listData: any;
    selectedRow: InvCkdStockIssuingDto;
    rowdata: any[];
    ...
    show(id): void {
        ...
        this.recordId = id;
        this.tableName = 'InvCkdStockIssuing';
    ...
    getData() {
        this._service.getStockIssuingHistory(
            this.recordId,
            this.tableName,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getStockIssuingHistory(
            this.recordId,
            this.tableName,
            '',
            this.paginationParams.skipCount,
