...
import { MstCmmUomDto, MstCmmUomServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class UomComponent extends AppComponentBase implements OnInit {
    @ViewChild('createOrEditModalUom', { static: true }) createOrEditModalUom: | CreateOrEditUomModalComponent | undefined;
    ...
    selectedRow: MstCmmUomDto = new MstCmmUomDto();
    saveSelectedRow: MstCmmUomDto = new MstCmmUomDto();
    datas: MstCmmUomDto = new MstCmmUomDto();
    ...
    constructor(
        injector: Injector,
        private _service: MstCmmUomServiceProxy,
    ...
    onChangeRowSelection(params: { api: { getSelectedRows: () => MstCmmUomDto[] } }) {
        this.saveSelectedRow = params.api.getSelectedRows()[0] ?? new MstCmmUomDto();
    ...
    deleteRow(system: MstCmmUomDto): void {
